...
public class DesignatorSignatureAct extends DesignatorStatement {

    private Designator Designator;
    private ActParsOptional ActParsOptional;

    public DesignatorSignatureAct (Designator Designator, ActParsOptional ActParsOptional) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorSignatureAct(\n");
