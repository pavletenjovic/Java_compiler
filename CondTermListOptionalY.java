...
public class CondTermListOptionalY extends CondTermListOptional {

    private CondTermListOptional CondTermListOptional;
    private CondTerm CondTerm;

    public CondTermListOptionalY (CondTermListOptional CondTermListOptional, CondTerm CondTerm) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("CondTermListOptionalY(\n");
